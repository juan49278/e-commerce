...
function showCart(list) {
    ...
    for (product of list) {
        ...
        <td><svg onclick="deleteItem(${id}),calcular()" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar producto" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="red" class="bi bi-trash" viewBox="0 0 16 16">
